    ...
    <div class="modal fade" id="exampleModalCenteredScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('teacher.grade.add')}}" method="post">

                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="magazine_id" value="{{$magazine->id}}">
                        <input type="hidden" name="class_id" value="{{$magazine->class->id}}">

                        <label for="grade" class="form-label">Бал</label>
                        <input type="number" name="grade" id="grade" class="form-control">
                        <label for="topic" class="form-label">Тема</label>
                        <input type="text" name="topic" id="topic" class="form-control">
                       <label for="student_id" class="form-label">Ученики</label>
            ...
            "placeholder": "Select user..."
                                ...
                                @foreach($magazine->class->students as $student)
                                    <option value="{{ $student->id }}">{{ $student->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <label for="date" class="form-label">Дата</label>
                        <input type="text" name="date" class="js-flatpickr form-control flatpickr-custom" placeholder="Select dates"
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Классы</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{$magazine->class->literal_int}}</li>
                        </ol>
                    </nav>

                    <h1 class="page-header-title">Класс: {{$magazine->class->literal_int.$magazine->class->literal_char.','.$magazine->subject->subject}}</h1>
                </div>
                <!-- End Col -->
